...
public class SellerOrderController {
    ...
    public ModelAndView list(@RequestParam(value = "page", defaultValue = "1") Integer page,
        ...
        Page<OrderDTO> orderDTOPage = iOrderMasterService.findList(page, size);
...
//        orderDTOPage.getTotalPages()
    ...
    public ModelAndView cancel(@RequestParam("orderId") String orderId,
                               Map<String, Object> map) {
        try {
            OrderDTO orderDTO = iOrderMasterService.findOne(orderId);
            iOrderMasterService.cancel(orderDTO);
    ...
    public ModelAndView detail(@RequestParam("orderId") String orderId,
        ...
        try {
            orderDTO = iOrderMasterService.findOne(orderId);
        } catch (SellException e) {
    ...
    public ModelAndView finished(@RequestParam("orderId") String orderId,
        ...
        try {
            OrderDTO orderDTO = iOrderMasterService.findOne(orderId);
            iOrderMasterService.finish(orderDTO);
        } catch (SellException e) {
